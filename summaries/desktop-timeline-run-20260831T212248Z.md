...
⚠⚠ **51% of the sampled cycles are a COMPILE, more than
the game's own 48%.** A build ran inside this capture.
...
The profiler cost 1% of sampled cycles. Low enough that the
